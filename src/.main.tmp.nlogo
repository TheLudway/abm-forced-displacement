...
to-report pareto-random [alpha xm]
...
to prod-cana-de-azucar
  ask campesinos [
    if not migrant [
      set total_money total_money + (8432.50  * pareto-random 1 1 )
    ]
  ]
end
...
to prod-citrico
  ask campesinos [
    if not migrant [
      set total_money total_money + (9531.75 * pareto-random 1 1 )
    ]
  ]
end
...
to prod-maracuya
  ask campesinos [
    if not migrant [
      set total_money total_money + (7890.00 * pareto-random 1 1 )
    ]
  ]
end
...
to prod-aceite
  ask campesinos [
    if not migrant [
      set total_money total_money + (11200.40 * pareto-random 1 1 )
    ]
  ]
end
...
to prod-pina
  ask campesinos [
    if not migrant [
      set total_money total_money + (6785.20 * pareto-random 1 1 )
    ]
  ]
end
...
to prod-platano
  ask campesinos [
    if not migrant [
      set total_money total_money + (8021.15 * pareto-random 1 1 )
    ]
  ]
end
...
to evaluar-migracion
  ask campesinos [
    if not migrant [
      if (nivel_violencia > tolerance_level) [
        set migrant true
        set color gray
      ]
    ]
